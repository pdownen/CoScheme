...
\item \Cref{sec-correctness} demonstrates correctness in terms of an equational theory for reasoning about copattern-matching code in the source language, which is a convervative extension of the target language, and we prove is sound with respect to translation.
\end{itemize} 
